(() => {
  ...
  // ns-params:@params
  var params_default = { baseURL: "http://localhost:1313/", breadcrumb: true, carouselpostcount: 5, color: "auto", counttaxonomyposts: false, customcss: [], customjs: [], dateformat: ":date_long", diagram: false, docsnav: { reducefontsize: true }, featuredpostcount: 5, feeds: { content: false }, fixedheader: true, fullwidth: false, mainsections: ["posts", "docs"], palette: "blue", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 1, postdate: true, poweredby: false, readingtime: true, recentpostcount: 5, relatedpostcount: 5, rss: false, sass_transpiler: "libsass", searchbar: false, sidebartaxonomies: ["series", "categories", "tags", "authors"], taxonomypaginate: 10, taxonomypostcount: 3, titlecase: false, titleseparator: "-", tocwordcount: 280, viewer: true };
